...
let bsNav: NavBarCollapsible;

onMounted(async () => {
  await nextTick();
  if (nav.value instanceof HTMLElement) {
    bsNav = new NavBarCollapsible(nav.value);
  }
});

onUnmounted(() => bsNav?.dispose());
        ...
        <div class="col-12">
          <div class="navbar navbar-expand-lg has-megamenu">
            ...
            <div id="header-nav" ref="nav" class="navbar-collapsable">
              ...
              <div class="close-div">
                <Button class="close-menu" plain @click="closeNav()">
                ...
                <div v-if="settings.socials?.length" class="it-socials">
                  ...
                  <ul class="list-unstyled">
                    <li v-for="social in settings.socials" :key="social.name">
                      <NuxtLink :to="social.path" target="_blank" @click="closeNav()">
